...
const char* ei_classifier_inferencing_categories[] = { "Calculator", "Earphone", "Phone" };

ei_dsp_named_axis_t ei_dsp_config_4_named_axes[] = {
    { .name = "Image", .axis = 0 }
};
size_t ei_dsp_config_4_named_axes_size = 1;
EI_CLASSIFIER_DSP_AXES_INDEX_TYPE ei_dsp_config_4_axes[] = { 0 };
...
const ei_impulse_t impulse_695607_0 = {
    .project_id = 695607,
    .project_owner = "DamThang",
    .project_name = "DamThang-project-1",
    .impulse_id = 1,
...
ei_impulse_handle_t impulse_handle_695607_0 = ei_impulse_handle_t( &impulse_695607_0 );
ei_impulse_handle_t& ei_default_impulse = impulse_handle_695607_0;
